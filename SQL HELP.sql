...
yyy			|| Nazwa kolumny z Tabeli xxx			(Bierzemy z bazy)
zzz			|| Jakakolwiek wartość zgodna z typem
id=1			|| Wskazujemy konkretną kolumnę lub wiele 	(w to pole należy podać jakąś unikatową wartość po której program będzie w stanie określić ->
			   						-> dokładnie tą komórkę lub podajemy wartość wspólną dla wielu kolumn)
*/
