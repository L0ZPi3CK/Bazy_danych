...
Samochody, których marka zaczyna siê na H
-- select Marka, Model, Kolor from Samochody where Marka like ’H%’

Samochody, których marka koñczy siê na a
-- select Marka, Model, Kolor from Samochody where Marka like ’%a’

Samochody, których marka ma drug¹ literê o
...
Samochody, których marka nie zaczyna siê na literê F
